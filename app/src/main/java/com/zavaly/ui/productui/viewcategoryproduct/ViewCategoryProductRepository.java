package com.zavaly.ui.productui.viewcategoryproduct;
                    ...
                    if (response.code() == 200) {
                        ...
                        if (response.body().getSuccess()) {
                            ...
                            if (response.body().getCats().getProducts() != null) {
                                ...
                                ProductsRecyclerAdapter adapter = new ProductsRecyclerAdapter(context, null, response.body().getCats().getProducts(), null, null, String.valueOf(ZavalyEnums.List_Solo_Cat));
